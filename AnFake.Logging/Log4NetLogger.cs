...
{
	public sealed class Log4NetLogger : Api.ILogger
	{
		...
		public Log4NetLogger(Verbosity verbosity, int consoleWidth)
			: this(null, verbosity, consoleWidth)
		{
		}
		...
		private void SetUp(string logPath, Verbosity verbosity, int consoleWidth)
		{
			...
			hierarchy.Root.Level = GetLevelThreshold(verbosity);
