...
namespace AnFake.Api.Pipeline.Test
{
	...
	public class ParallelPipelineStepTest
	{
		...
		public void Initialize()
		{
			...
			TestStep = new ParallelPipelineStep(SubStep1, SubStep2);
			Pipeline = new Pipeline(TestStep, Impl);
		}

		[TestCategory("Unit")]
		[TestMethod]
		public void ParallelStep_should_run_substeps_simultaneously()
		{
			// arrange
		...
		[TestCategory("Unit")]
		[TestMethod]
		public void ParallelStep_should_return_queued_if_first_queued()
		{
			// arrange
			SubStep1.Stub(x => x.Step(Pipeline))
				.Return(PipelineStepStatus.Queued);
		...
		[TestCategory("Unit")]
		[TestMethod]
		public void ParallelStep_should_return_queued_if_second_queued()
		{
			// arrange
			SubStep1.Stub(x => x.Step(Pipeline))
				.Return(PipelineStepStatus.Succeeded);
		...
		[TestCategory("Unit")]
		[TestMethod]
		public void ParallelStep_should_return_in_progress_if_first_in_progress()
		{
			// arrange
			SubStep1.Stub(x => x.Step(Pipeline))
		...
		[TestCategory("Unit")]
		[TestMethod]
		public void ParallelStep_should_return_in_progress_if_second_in_progress()
		{
			// arrange
			SubStep1.Stub(x => x.Step(Pipeline))
				.Return(PipelineStepStatus.Succeeded);
		...
		[TestCategory("Unit")]
		[TestMethod]
		public void ParallelStep_should_return_failed_if_first_failed()
		{
			// arrange
			SubStep1.Stub(x => x.Step(Pipeline))
		...
		[TestCategory("Unit")]
		[TestMethod]
		public void ParallelStep_should_return_failed_if_second_failed()
		{
			// arrange
			SubStep1.Stub(x => x.Step(Pipeline))
				.Return(PipelineStepStatus.Succeeded);
		...
		[TestCategory("Unit")]
		[TestMethod]
		public void ParallelStep_should_return_partial_success_if_first_partially_succeeded()
		{
			// arrange
			SubStep1.Stub(x => x.Step(Pipeline))
		...
		[TestCategory("Unit")]
		[TestMethod]
		public void ParallelStep_should_return_partial_success_if_second_partially_succeeded()
		{
			// arrange
			SubStep1.Stub(x => x.Step(Pipeline))
				.Return(PipelineStepStatus.Succeeded);
		...
		[TestCategory("Unit")]
		[TestMethod]
		public void ParallelStep_should_return_success_if_both_succeeded()
		{
			// arrange
			SubStep1.Stub(x => x.Step(Pipeline))
				.Return(PipelineStepStatus.Succeeded);
